...
public class ButtonCanWave extends Button {
    ...
    public ButtonCanWave(Context context, AttributeSet attrs) {
        super(context, attrs);
        initPaint();
    ...
    * */
    private void initPaint() {
        ...
        bottomPaint.setColor(getResources().getColor(R.color.bbutton_danger_edge));
    }
